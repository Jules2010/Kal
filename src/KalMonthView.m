...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextDrawTiledImage(ctx, (CGRect){CGPointZero,[KalGridView tileSize]}, [[UIImage imageNamed:@"Kal.bundle/kal_tile.png"] CGImage]);
}
...
- (void)sizeToFit
{
    self.height = 1.f + [KalGridView tileSize].height * numWeeks;
}
